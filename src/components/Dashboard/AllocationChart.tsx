...
export function AllocationChart() {
    ...
    // ⚡ Bolt Optimization: Memoize chart data generation to prevent expensive sorting
    // and array allocations on every render.
    // Impact: Avoids O(N log N) sorting operation during unrelated component updates.
    const { chartData, finalData } = useMemo(() => {
        ...
        return { chartData: sortedData, finalData: finalDataResult };
    }, [holdings]);
