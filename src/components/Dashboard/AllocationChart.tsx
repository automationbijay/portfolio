...
export function AllocationChart() {
    ...
    // ⚡ Bolt Optimization: Memoize chart data calculations
    // Why: Prevents re-sorting and slicing the potentially large `holdings` array on every render.
    // Impact: Eliminates O(N log N) sorting and multiple O(N) array traversals during standard re-renders.
    const { chartData, finalData } = useMemo(() => {
        ...
        return { chartData: sortedData, finalData: aggregatedData };
    }, [holdings]);
