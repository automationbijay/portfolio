...
export function AllocationChart() {
    ...
    // ⚡ Bolt: Memoize expensive data transformations (clone, sort, reduce)
    // 🎯 Why: Sorting the entire portfolio on every re-render is an O(N log N) operation that degrades performance for users with many holdings.
    // 📊 Impact: Prevents unnecessary processing overhead during state updates that don't modify the holdings list.
