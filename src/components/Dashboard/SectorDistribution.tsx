...
export function SectorDistribution() {
    ...
    // Memoize the sector distribution calculations to prevent expensive object
    // reduction, sorting, and array mapping on every render.
