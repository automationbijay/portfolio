...
export function SectorDistribution() {
    ...
    // ⚡ Bolt: Memoize expensive data transformations (reduce, Object.entries, sort, slice)
    // 🎯 Why: This avoids recalculating and sorting the holdings array on every re-render, especially costly when the portfolio is large.
    // 📊 Impact: Reduces CPU time during re-renders by preventing O(N log N) sorting and O(N) reductions when holdings haven't changed.
