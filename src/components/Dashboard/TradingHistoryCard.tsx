...
export function TradingHistoryCard() {
    ...
    const { sections, hasData } = useMemo(() => {
        ...
        const calculatedHasData = calculatedSections.market.length > 0 || calculatedSections.rewards.length > 0;

        return { sections: calculatedSections, hasData: calculatedHasData };
